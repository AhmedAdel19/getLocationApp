...
public class MyLocationService extends BroadcastReceiver
{
    ...
    static String username_loc , password_loc;
    static String usernameJ , passwordJ;
...
//    }
    ...
    private void downloadJSON(final String urlWebService) {
        ...
        class DownloadJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPostExecute(String s) {
               ...
               // String usernameJ = null, passwordJ = null;
                try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    try {
                         usernameJ = obj.getString("username");
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    try {
                         passwordJ =  obj.getString("password");
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
    ...
    private void get_user(String json) throws JSONException {
        JSONArray jsonArray = new JSONArray(json);
        String[] stocks = new String[jsonArray.length()];
        for (int i = 0; i < jsonArray.length(); i++) {
            JSONObject obj = jsonArray.getJSONObject(i);
            stocks[i] = obj.getString("username") + " " + obj.getString("password");
        }
